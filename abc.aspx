<%@ Page Title="" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="abc.aspx.cs" Async="true" Inherits="abc" %>
       ...
       <asp:RegularExpressionValidator
                   ...
                   ValidationExpression="^([234])([0-9]{7})$" ></asp:RegularExpressionValidator>
					  ...
					  <%--<div class="col-xs-4">
                          ...
                          <asp:TextBox MaxLength="30" autocomplete="off" runat="server" ID="txtFirstName" CssClass="form-control" placeholder="First Name"></asp:TextBox>
                          <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ErrorMessage="Required" ControlToValidate="txtFirstName" style="color: red" Display="Dynamic"></asp:RequiredFieldValidator>
                           <asp:regularexpressionvalidator style="color: red" controltovalidate="txtFirstName" display="Dynamic" errormessage="First Name is not formatted correctly." id="RegularExpressionValidator67" runat="Server" validationexpression="^[a-zA-Z][a-zA-Z -']+(([' -][a-zA-Z ])?[a-zA-Z]*)*$" />
						  </div>--%>
...
<%--					 <div class="col-xs-4">
 ...
 <asp:regularexpressionvalidator style="color: red" controltovalidate="txtdep" display="Dynamic" errormessage="Designation is not formatted correctly." id="RegularExpressionValidator5" runat="Server" validationexpression="^[A-Za-z\s.&]{2,50}$"></asp:regularexpressionvalidator>
                     ...
                     <asp:Button runat="server" ID="btnSubmit" CssClass="btn bg-olive margin" Text="Submit" OnClick="btnSubmit_Click" />
